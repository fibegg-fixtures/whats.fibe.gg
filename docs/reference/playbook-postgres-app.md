...
slug: /reference/playbook-postgres-app
sidebar_label: "Postgres App"
image: /img/og/reference-playbook-postgres-app.png
keywords: ["Fibe", "Playbook", "playbook", "postgres", "app"]
