...
slug: /reference/playbook-rails-app
sidebar_label: "Rails App"
image: /img/og/reference-playbook-rails-app.png
keywords: ["Fibe", "Playbook", "playbook", "rails", "app"]
...
x-fibe.gg:
  variables:
    ...
    JOBS_REPLICAS:
      ...
      default: "2"
      validation: "/^[1-9][0-9]*$/"
      path: services.jobs.deploy.replicas
  metadata:
