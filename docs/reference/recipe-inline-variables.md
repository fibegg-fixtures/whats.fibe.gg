...
description: "Use to embed `$$var__NAME` inside Compose string values, label values, image tags, URLs, and partial strings - and to understand when the inline form is required vs optional."
slug: /reference/recipe-inline-variables
sidebar_label: "Inline Variables"
image: /img/og/reference-recipe-inline-variables.png
keywords: ["Fibe", "Recipe", "recipe", "inline", "variables"]
