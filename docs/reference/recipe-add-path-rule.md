...
slug: /reference/recipe-add-path-rule
sidebar_label: "Add Path Rule"
image: /img/og/reference-recipe-add-path-rule.png
keywords: ["Fibe", "Recipe", "recipe", "add", "path", "rule"]
