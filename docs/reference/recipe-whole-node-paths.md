...
slug: /reference/recipe-whole-node-paths
sidebar_label: "Whole Node Paths"
image: /img/og/reference-recipe-whole-node-paths.png
keywords: ["Fibe", "Recipe", "recipe", "whole", "node", "paths"]
