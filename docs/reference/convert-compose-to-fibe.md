...
slug: /reference/convert-compose-to-fibe
sidebar_label: "Convert Compose To Fibe"
image: /img/og/reference-convert-compose-to-fibe.png
keywords: ["Fibe", "Skill", "convert", "compose", "to", "fibe"]
