---
title: "Help"
description: "Use when you need to read the CLI long help for any fibe subcommand (flag descriptions, examples, payload shapes)."
slug: /reference/tools/help
sidebar_label: "Help"
image: /img/og/reference-tools-help.png
keywords: ["Fibe", "Tool", "fibe", "tool", "help"]
...
Returns the short/long/help text for a `fibe <path>` command. No API call, no auth required.
