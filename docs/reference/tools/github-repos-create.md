---
title: "Github Repos Create"
description: "Use when you need to create a new GitHub repository under the Player's OAuth-connected GitHub account."
slug: /reference/tools/github-repos-create
sidebar_label: "Github Repos Create"
image: /img/og/reference-tools-github-repos-create.png
keywords: ["Fibe", "Tool", "fibe", "tool", "github", "repos", "create"]
