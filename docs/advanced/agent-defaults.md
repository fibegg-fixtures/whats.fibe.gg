...
| **CLI arguments** | Extra provider CLI flags applied to new Genies. Unsafe flags are ignored. |
| **Skills** | Choose which built-in skills are synced into Genie workspaces; unchecked skills are not mounted. |
