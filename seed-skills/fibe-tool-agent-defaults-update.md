---
name: fibe-tool-agent-defaults-update
...
2. Normalizes the payload (deep-stringifies keys, converts inline `provider_args_cli` strings into structured `provider_args`).
